...
<body class="sub_page">
  ...
  <div class="container text-center" style= "background-color:white; margin: auto; padding-top: 40px;">
    <h1 class="fa fa-align-center" aria-hidden="true">List of Customers</h1> 
