...
<body class="sub_page">
  ...
  <div class="container" style= "background-color:white; margin: auto; padding-top: 30px;padding-bottom: 80px; width:600px;">
    ...
    <form:form action="/customer/updatedetails" modelAttribute="customer" method="post">
    ...
    <div class="form-group">
      ...
      <div class="form-group">
        ...
        <form:input type="email" path="email" value="${customer.email}"
