...
<body class="sub_page">
  ...
  <div class="container text-left" style= "background-color:white; margin: auto; padding-top: 50px;width:700px">
    <div class="card card-body" style="background-color:cornflowerblue;">
    <h4 style="font-family:'Times New Roman', Times, serif ;text-align:center;">Customer Details:-</h4>
    <form:form action="/tripbooking/viewdrivertrips" method="get" modelAttribute="tripss">
        <div class="form-group">
            <label for="userName">User Name</label>
            <input type="text" disabled  value="${customer.userName}"
              class="form-control" name="" id="userName"/>
          </div>
            <div class="form-group">
              <label for="mobileNumber">Mobile No</label>
              <input type="text" disabled value="${customer.mobileNumber}"
                class="form-control" name="" id="mobileNumber"/>
            </div>
            <div class="form-group">
              <label for="email">Email id</label>
              <input type="text"  type="email" disabled value="${customer.email}"class="form-control" name="" id="email"/>
            </div>
