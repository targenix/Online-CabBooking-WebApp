...
<body class="sub_page">
  ...
  <div class="container" style= "background-color:white; margin: auto; padding-top: 10px;padding-bottom: 200px; width:600px;">
    <div class="card card-body" style="background-color: burlywood;">
    <h4 style="font-family:'Times New Roman', Times, serif ;text-align:center; color:olivedrab">Your Details<br> Once you press Deactivate button your account will get deactivated!!</h4>
    <form:form action="/customer/deldetails" modelAttribute="customer" method="post">
    ...
    <div class="form-group">
        ...
        <form:input type="password" path="password" value="${customer.password}"
