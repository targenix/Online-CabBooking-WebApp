            ...
            <tbody>
                ...
                List<TripBooking> lists = (List<TripBooking>) request.getAttribute("trips");
                    ...
                    for(TripBooking tripss: lists)
                    {
                        ...
                        out.println("<td>"+tripss.getStatus()+" </td>");
                        out.println("<td>"+tripss.getFromLocation()+" </td>");
                        out.println("<td>"+tripss.getToLocation()+" </td>");
                        out.println("<td><a href=\"http://localhost:5000/tripbooking/viewtripdet?tripbookingId=" + tripss.getTripBookingId() + "\"><button>View</button></a></td>");
                        out.println("<td><a href=\"http://localhost:5000/customer/viewdrivercus?customerId=" + tripss.getCustomer().getCustomerId() + "\"><button>Customer</button></a></td>");
                        out.println("</tr>");
