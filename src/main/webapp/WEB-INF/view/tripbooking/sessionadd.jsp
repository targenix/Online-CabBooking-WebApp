...
<body class="sub_page">
  ...
  <div class="container" style= "background-color:white; margin: auto; padding-top: 40px;padding-bottom:100px; width:700px;">
    <div class="card card-body" style="background-color:cornflowerblue;">
      <h3 style="font-family:'Times New Roman', Times, serif ;text-align:center; color:aliceblue">Book your Trip</h3>
    <form:form action="booktrips" modelAttribute="trip" method="get"> 
      ...
      <form:hidden path="cab" value="${trip.cab.cabId}"/>
       <div class="form-group">
        ...
        <form:select path="fromLocation" 
          class="form-control" name="" id="fromLocation">
          <form:option  value="Haldia" label="Haldia"/>
          <form:option  value="Howrah" label="Howrah"/>
    ...
    <div class="form-group">
        <label for="fromDateTime"style="font-family:'Times New Roman', Times, serif ;text-align:center; color:aliceblue">DateTime of Journey</label>
        <form:input  path="fromDateTime" 
          class="form-control" name="" id="fromDateTime"  required="required"/>
    </div>
    <input type="reset"/>
    <div class="form-group"style="text-align: center;">
      <a href=\"http://localhost:5000/tripbooking/booktrip?cabId=" + trip.cab.getCabId() + "\"><button type="submit" class="btn btn-primary">Proceed</button></a>
    </div>
</form:form>
</div>
</div>
