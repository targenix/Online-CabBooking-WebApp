...
<body class="sub_page">
  ...
  <div class="container" style= "background-color:white; margin: auto; padding-top: 90px;padding-bottom:200px ;width:600px;">

    <div class="alert alert-danger"> <h4 style="font-family:'Times New Roman', Times, serif ;text-align:center; color:chocolate">No Trip Details Found</h4></div>
    <form:form action="/tripbooking/getcabs"  method="get">
    <h4 style="font-family:'Times New Roman', Times, serif ;text-align:center; color:cadetblue">Book a ride to your favourite destination !NOW</h4>
    
    <div class="form-group"style="text-align: center;">
      <button type="submit" class="btn btn-primary">Book a Trip</button>
    </div>
</form:form>
</div>
