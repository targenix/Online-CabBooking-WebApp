...
<body class="sub_page">
  ...
  <div class="container" style= "background-color:white; margin: auto; padding-top: 110px; padding-bottom:300px;width:600px;">
    <form:form action="/tripbooking/getcabs" modelAttribute="trip" method="get">
      <div class="alert alert-danger"> <h4 style="font-family:'Times New Roman', Times, serif ;text-align:center; color:chocolate">Sorry !Ride is not available for this location</h4></div>
    <div class="form-group"style="text-align:center">
        <button type="submit" class="btn btn-primary">Book Ride for Different Location</button>
      </div>
    </form:form>
</div>
