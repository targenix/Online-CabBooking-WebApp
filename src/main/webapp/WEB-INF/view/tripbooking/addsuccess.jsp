...
<body class="sub_page">
  ...
  <div class="container" style= "background-color:white; margin: auto; padding-top: 80px;padding-bottom:300px; width:600px;">
    <h3 style="font-family:'Times New Roman', Times, serif ;text-align:center; color:brown">Happy Journey</h3>
    <div class="alert alert-success"><h4 style="font-family:'Times New Roman', Times, serif ;text-align:center; color:darkgreen">Your Trip is Booked</h4></div>
    
    <form:form action="booktrip" modelAttribute="trip" method="get"> 
    <div class="form-group"style="text-align:center">
      <button type="submit" class="btn btn-primary">Book another trip</button>
    </div>
</form:form>
  </div>
