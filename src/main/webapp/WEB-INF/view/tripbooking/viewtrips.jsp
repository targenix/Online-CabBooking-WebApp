...
<body class="sub_page">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="d-flex ml-auto flex-column flex-lg-row align-items-center">
              <ul class="navbar-nav  ">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="/tripbooking/deletetrip">Delete Trip</a>
                </li>
  ...
  <div class="container text-left" style= "background-color:white; margin: auto; padding-top: 10px;width:700px">
    <div class="card card-body" style="background-color:cornflowerblue;">
    <h4 style="font-family:'Times New Roman', Times, serif ;text-align:center;">Trip Details:-</h4>
    <form:form action="/tripbooking/viewalltrips" method="get" modelAttribute="tripss">
      <div class="form-group">
            <label for="tripBookingId"style="font-family:'Times New Roman', Times, serif ;text-align:left; color:aliceblue">TripBookingId</label>
      ...
      <div class="form-group">
        <label for="fromDateTime"style="font-family:'Times New Roman', Times, serif ;text-align:left; color:aliceblue">From</label>
        <input type="text" disabled value="${tripss.fromDateTime}" class="form-control" id="fromDateTime"/>
      </div>
      <div class="form-group">
        <label for="toDateTime"style="font-family:'Times New Roman', Times, serif ;text-align:left; color:aliceblue">To</label>
        <input type="text" disabled value="${tripss.toDateTime}" class="form-control" id="toDateTime"/>
      </div>
      <div class="form-group">
        <label for="fromLocation"style="font-family:'Times New Roman', Times, serif ;text-align:left; color:aliceblue">Pickup</label>
        <input type="text" disabled value="${tripss.fromLocation}" class="form-control" id="fromLocation"/>
      </div>
      <div class="form-group">
        <label for="toLocation"style="font-family:'Times New Roman', Times, serif ;text-align:left; color:aliceblue">Drop</label>
      ...
      <div class="form-group">
        <label for="distanceInKm"style="font-family:'Times New Roman', Times, serif ;text-align:left; color:aliceblue">Distance(in Km)</label>
        <input type="text" disabled value="${tripss.distanceInKm}" class="form-control" id="distanceInKm"/>
      </div>
      <div class="form-group">
        <label for="bill"style="font-family:'Times New Roman', Times, serif ;text-align:left; color:aliceblue">Charges</label>
