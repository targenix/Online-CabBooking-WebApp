...
<body class="sub_page">
  ...
  <div class="container text-center" style= "background-color:white; margin: auto; padding-top: 10px;padding-bottom:200px">
    <h1 style="font-family:'Times New Roman', Times, serif ;text-align:center;color:chocolate">Available Rides</h1>
            ...
            <tbody>
                ...
                List<Cab> lists = (List<Cab>) request.getAttribute("cabs");
                    ...
                    for(Cab cabss: lists)
                    {
                        ...
                        out.println("<td><a href=\"http://localhost:5000/tripbooking/booktrip?cabId=" + cabss.getCabId() + "\"><button>Book Trip</button></a></td>");
                        out.println("</tr>");
