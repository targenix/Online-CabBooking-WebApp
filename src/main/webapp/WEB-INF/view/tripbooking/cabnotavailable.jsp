...
<body class="sub_page">
  ...
  <div class="container" style= "background-color:white; margin: auto; padding-top: 90px; padding-bottom:200px;width:600px;">
    <form:form action="getcabs"  method="get">
      <div class="alert alert-danger"> <h4 style="font-family:'Times New Roman', Times, serif ;text-align:center; color:chocolate">Sorry!No Cab is available at this time..<br>Try again after few time</h4></div>
