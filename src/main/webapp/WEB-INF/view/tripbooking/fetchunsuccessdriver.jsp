...
<body class="sub_page">
  ...
  <div class="container" style= "background-color:white; margin: auto; padding-top: 90px;padding-bottom:200px ;width:600px;">
    ...
    <div class="alert alert-danger"> <h4 style="font-family:'Times New Roman', Times, serif ;text-align:center; color:chocolate">No Trip Available for You</h4></div>
    <form:form action="/driver.html">
    <h4 style="font-family:'Times New Roman', Times, serif ;text-align:center; color:cadetblue">Wait Until SomeOne books You</h4>
