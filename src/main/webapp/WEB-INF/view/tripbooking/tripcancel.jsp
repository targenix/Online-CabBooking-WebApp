...
<body class="sub_page">
  ...
  <div class="container" style= "background-color:white; margin: auto; padding-top: 110px; padding-bottom:300px;width:600px;">
    ...
    <form:form action="viewalltrips" modelAttribute="trip" method="get">
      <div class="alert alert-danger"> <h4 style="font-family:'Times New Roman', Times, serif ;text-align:center; color:chocolate">Your Trip is Cancelled</h4></div>
