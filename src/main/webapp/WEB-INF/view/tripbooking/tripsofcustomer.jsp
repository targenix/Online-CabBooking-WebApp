...
<body class="sub_page">
  ...
  <div class="container" style= "background-color:white; margin: auto; padding-top: 50px; width:600px;">

    <form:form action="viewalltrips" modelAttribute="customer" method="get"> 
