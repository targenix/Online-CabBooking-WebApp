...
<body class="sub_page">
  ...
  <div class="container" style= "background-color:white; margin: auto; padding-top: 70px;padding-bottom:200px; width:600px;">
    ...
    <form:form action="updatedetails" modelAttribute="cab" method="post">
      <form:hidden path="cabId" value="${cab.cabId}"/>
      <div class="form-group">
        <label for="carType">CarType</label>
        <form:input path="carType" value="${cab.carType}"
          class="form-control" name="" id="carType"/>
      </div>
      <div class="form-group">
        <label for="perKmRate">RateperKm</label>
        <form:input path="perKmRate" value="${cab.perKmRate}"
