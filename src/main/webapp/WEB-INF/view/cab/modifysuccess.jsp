...
<body class="sub_page">
  ...
  <div class="container text-center" style= "background-color:white; margin: auto; padding-top: 100px;padding-bottom:300px; width:600px;">
    ...
    <form:form action="/cab/listcabs" modelAttribute="cab" method="get"> 
<div class="alert alert-success"><h4 style="font-family:'Times New Roman', Times, serif ;text-align:center; color:olivedrab">Cab Details Updated Successfully</h4></div>
<div class="form-group">
<button type="submit" class="btn btn-lg btn-primary btn-block">Back</button>
</div>
</form:form>
</div>
