...
<div class="alert alert-success"><h4 style="font-family:'Times New Roman', Times, serif ;text-align:center; color:olivedrab">Cab registered successfully</h4></div>
<div class="form-group">
<button type="submit" class="btn btn-lg btn-primary btn-block">Add more Cabs</button>
</div>
</form:form>
</div>
