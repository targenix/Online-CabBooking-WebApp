...
<body class="sub_page">
  ...
  <div class="container" style= "background-color:white; margin: auto; padding-top: 50px; padding-bottom:200px;width:600px;">
    <div class="card card-body" style="background-color: burlywood;">
      <h3 style="font-family:'Times New Roman', Times, serif ;text-align:center; color:cornsilk">Register new Cab</h3>
    <form:form action="addcab" modelAttribute="cab" method="post"> 
    ...
    <div class="form-group">
        ...
        <form:input path="perKmRate" 
          class="form-control" name="" id="ratePerKm" required="required"/>
      </div>
      <div class="form-group">
        <label for="driver">Driver</label>
        <form:input path="driver" 
          class="form-control" name="" id="driver" required="required"/>
      </div>
