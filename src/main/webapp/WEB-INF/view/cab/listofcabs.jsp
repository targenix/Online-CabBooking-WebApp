...
<body class="sub_page">
  ...
  <div class="container text-center" style= "background-color:white; margin: auto; padding-top: 30px;">
    <h3 style="font-family:'Times New Roman', Times, serif ;text-align:center; color:crimson">List of  ${cab.carType}</h3> 
    <div class="form-group"style="text-align:left"><a href="/cab/findbycabtype">
