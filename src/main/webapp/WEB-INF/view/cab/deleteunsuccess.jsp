...
<body class="sub_page">
  ...
  <div class="container text-center" style= "background-color:white; margin: auto; padding-top: 80px;padding-bottom:300px; width:600px;">
    ...
    <form:form action="/cab/deletecab" modelAttribute="cab" method="get"> 
<div class="alert alert-danger"><h4 style="font-family:'Times New Roman', Times, serif ;text-align:center; color:olivedrab">Record can't be deleted</h4></div>
