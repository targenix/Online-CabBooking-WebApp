...
<body class="sub_page">
  ...
  <div class="container text-center" style= "background-color:white; margin: auto; padding-top: 10px;padding-bottom:200px">
    <h1 style="font-family:'Times New Roman', Times, serif ;text-align:center;color:chocolate">Cabs</h1>
        <table class="table table-dark" align="center">
            ...
            <tbody>
                <%
                List<Cab> lists = (List<Cab>) request.getAttribute("cabs");

                    for(Cab cabss: lists)
                    {

                        out.println("<tr>");
                        out.println("<td scope=\"row\">"+cabss.getCabId()+"</td>");
                        out.println("<td>"+cabss.getCarType()+" </td>");
                        out.println("<td>"+cabss.getPerKmRate()+" </td>");
                        out.println("<td><a href=\"http://localhost:5000/cab/updatedetails?cabId=" + cabss.getCabId() + "\"><button>Edit</button></a></td>");
                        out.println("<td><a href=\"http://localhost:5000/cab/deldetails?cabId=" + cabss.getCabId() + "\"><button>Remove</button></a></td>");
                        out.println("</tr>");
