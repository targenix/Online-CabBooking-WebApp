...
<body class="sub_page">
  ...
  <div class="container text-center" style= "background-color:white; margin: auto; padding-top: 80px;padding-bottom:300px; width:600px;">
    ...
    <form:form action="/cab/countcabbytype" modelAttribute="cab" method="get"> 
<div class="alert alert-danger"><h4 style="font-family:'Times New Roman', Times, serif ;text-align:center; color:chocolate">Cab Record not found</h4></div>
