...
<body class="sub_page">
      ...
      <div class="d-flex ml-auto flex-column flex-lg-row align-items-center">
        <ul class="navbar-nav  ">
         <!-- <li class="nav-item ">
          ...
          <!-- <li class="nav-item">
            <a class="nav-link" href="/cab/modifycab">Edit Cab</a>
          </li> -->
          <li class="nav-item">
  ...
  <div class="container" style= "background-color:white; margin: auto; padding-top: 70px;padding-bottom:200px;width:600px;">
    <div class="card card-body" style="background-color: burlywood;">
      <h3 style="font-family:'Times New Roman', Times, serif ;text-align:center; color:cornsilk">Cab Details</h3>
    <form:form action="deldetails" modelAttribute="cab" method="post">
      <form:hidden path="cabId" value="${cab.cabId}"/> 
      <div class="form-group">
        <label for="carType">CarType</label>
        <input type="text" disabled path="carType" value="${cab.carType}"
          class="form-control" name="" id="carType"/>
      </div>
      <div class="form-group">
        <label for="perKmRate">Rate/Km</label>
        <input type="text" disabled path="perKmRate" value="${cab.perKmRate}"
          class="form-control" name="" id="perKmRate"/>
      </div>
