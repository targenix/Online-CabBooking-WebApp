...
<body class="sub_page">
  ...
  <div class="container" style= "background-color:white; margin: auto; padding-top: 70px;padding-bottom:200px; width:600px;">
    <div class="card card-body" style="background-color: burlywood;">
      <h3 style="font-family:'Times New Roman', Times, serif ;text-align:center; color:cornsilk">View all Cab Records</h3>
    <form:form action="findbycabtype" modelAttribute="cab" method="post"> 
