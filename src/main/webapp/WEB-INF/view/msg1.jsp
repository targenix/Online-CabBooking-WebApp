...
<body>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-6 col-lg-9">
                    <div class="menu_text">
                        <ul>
                            ...
                            <li><a href="/admin/addadmin">Register</a></li>
                ...
                <div class="overlay-content">
                  ...
                  <a href="http://localhost:5000/admin/addadmin">Register</a>
    ...
    <!-- header section end -->
    <div class="container" style= background-color:cadetblue; margin: 5px; padding: 5px">
