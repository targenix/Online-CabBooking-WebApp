...
<body class="sub_page">
  ...
  <div class="container" style= "background-color:white; margin: auto; padding-top: 10px;padding-bottom: 100px; width:600px;">
    ...
    <form:form action="/admin/editdetails" modelAttribute="admin" method="get">
      <form:hidden path="adminId" value="${admin.adminId}"/> 
    <div class="form-group">
      <label for="userName">User Name</label>
      <input type="text" disabled path="userName" value="${admin.userName}"
        class="form-control" name="" id="userName"/>
    </div>
      <div class="form-group">
        <label for="mobileNumber">Mobile No</label>
        <input type="text" disabled path="mobileNumber" value="${admin.mobileNumber}"
          class="form-control" name="" id="mobileNumber"/>
      </div>
      <div class="form-group">
        <label for="email">Email id</label>
        <input type="text"  type="email" disabled path="email" value="${admin.email}"
