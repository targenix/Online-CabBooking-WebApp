...
<body class="sub_page">
  ...
  <div class="container text-center" style= "background-color:white; margin: auto; padding-top: 10px;padding-bottom:100px">
    <h3 style="font-family:'Times New Roman', Times, serif ;text-align:center;color:brown">List Of Driver Trips</h3>
