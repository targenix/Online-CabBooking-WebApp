...
<body class="sub_page">
  ...
  <div class="container text-center" style= "background-color:white; margin: auto; padding-top: 10px;padding-bottom:200px">
    <h3 style="font-family:'Times New Roman', Times, serif ;text-align:center;">List Of Trips</h3>
        ...
        <a href="/admin/tripsofcustomer"><button type="submit" class="btn btn-primary"> Back</button></a>
    </div>
