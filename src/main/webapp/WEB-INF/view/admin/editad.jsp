...
<body class="sub_page">
  ...
  <div class="container" style= "background-color:white; margin: auto; padding-top: 10px;padding-bottom: 100px; width:600px;">
    ...
    <form:form action="/admin/editdetails" modelAttribute="admin" method="post">
    ...
    <div class="form-group">
        ...
        <form:input type="password" path="password" value="${admin.password}"
      ...
      <div class="form-group">
        ...
        <form:input type="email" path="email" value="${admin.email}"
