...
<body class="sub_page">
  ...
  <div class="container" style= "background-color:white; margin: auto; padding-top: 10px;padding-bottom:100px; width:600px;">
    <h3 style="font-family:'Times New Roman', Times, serif ;text-align:center;">Driver Registration</h3>
    ...
    <div class="form-group">
        ...
        <form:input type="password" path="password"  placeholder="Password "
          class="form-control" name="" id="password" required="required"/>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        <!-- <label for="mobileNumber">Mobile</label> -->
        <form:input  path="licenceNo" placeholder="LicenceNo"
          class="form-control" name="" id="licenceNo" required="required"/>
      </div>
      <div class="form-group">
        <!-- <label for="mobileNumber">Mobile</label> -->
        <form:input  path="cab" placeholder="CabId"
          class="form-control" name="" id="cab" required="required"/>
      </div>
