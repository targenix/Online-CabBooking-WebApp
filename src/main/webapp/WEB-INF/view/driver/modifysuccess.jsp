          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="d-flex ml-auto flex-column flex-lg-row align-items-center">
              ...
              <div class="container" style= "background-color:white; margin: auto; padding-top: 70px;padding-bottom: 200px; width:600px;">
                <form:form action="/driver/viewdetails" method="get">
                    <div class="alert alert-success"> <h4 style="font-family:'Times New Roman', Times, serif ;text-align:center; color:olivedrab">Your Profile is updated</h4></div>
