...
<body class="sub_page">
    ...
    <div class="hero_area">
      ...
      <div class="container" style= "background-color:white; margin: auto; padding-top: 100px;padding-bottom: 100px; width:600px;">
        <div class="card card-body">
        <h3 style="font-family:'Times New Roman', Times, serif ;text-align:center; color:brown">Thanks for rating !!<br>Hope you had a great Journey!</h3>
        <form:form action="/tripbooking/viewalltrips" method="get">
    ...
    <section  class="info_section layout_padding-top layout_padding2-bottom"style="margin-top:150px">
      <div  class="container" >
        <div class="box">
          <div class="info_form">
            <h4>
