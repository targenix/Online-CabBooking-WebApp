...
<body class="sub_page">
              ...
              <ul class="navbar-nav  ">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="cab.html">Cab</a>
                            ...
                            <li class="nav-item">
                              <a class="nav-link" href="/driver/modifydriver">Update Account<span class="sr-only">(current)</span></a>
                            </li>
                            <!-- <li class="nav-item">
  ...
  <div class="container" style= "background-color:white; margin: auto; padding-top: 20px; width:600px;">
    <h3 style="font-family:'Times New Roman', Times, serif ;text-align:center;">Fetch Driver Details </h3> 
