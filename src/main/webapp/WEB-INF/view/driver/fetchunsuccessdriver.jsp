...
<body class="sub_page">
  ...
  <nav class="navbar navbar-expand-lg custom_nav-container ">
    ...
    <div class="container text-center" style= "background-color:white; margin: auto; padding-top: 80px;padding-bottom:300px; width:600px;">
        <div class="alert alert-danger"><h4 style="font-family:'Times New Roman', Times, serif ;text-align:center; color:chocolate"> Record not found</h4></div>
        <div class="form-group">
          <a href="/admin.html"><button type="submit" class="btn btn-lg btn-primary btn-block"> Back to Home Page</button></a>
        </div>
        </div>
  <section  class="info_section layout_padding-top layout_padding2-bottom"style="margin-top:300px">
    <div  class="container" >
      <div class="box">
        <div class="info_form">
          <h4>
