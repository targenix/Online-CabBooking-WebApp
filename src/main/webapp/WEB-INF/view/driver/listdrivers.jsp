...
<body class="sub_page">
  ...
  <div class="container text-center" style= "background-color:white; margin: auto; padding-top: 50px;padding-bottom:200px">
    <h3 style="font-family:'Times New Roman', Times, serif ;text-align:center;color:brown">List Of Drivers </h3> 
        <table class="table table-dark" align="center">
            ...
            <c:forEach items="${lists}" var="driver">
                <tr>
                    <!-- <td>${customer}</td> -->
