...
<body class="sub_page">
  ...
  <div class="hero_area">
    ...
    <!-- <nav class="navbar navbar-expand-lg custom_nav-container ">
      <a class="navbar-brand" >
       <span style="padding-bottom: 6px;">DriverProfile</span>
      </a> 
      </a>
      <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
        <span class="navbar-toggler-icon"></span>
  ...
  <div class="container" style= "background-color:white; margin: auto; padding-top: 20px;padding-bottom: 80px; width:600px;">
    <div class="card card-body" style="background-color: burlywood;">
    <h3 style="font-family:'Times New Roman', Times, serif ;text-align:center; color:cornsilk">Edit your Details</h3>
    <form:form action="/driver/editdriverdetails" modelAttribute="driver" method="post">
    ...
    <div class="form-group">
        ...
        <form:input type="password" path="password" value="${driver.password}"
      ...
      <div class="form-group">
        ...
        <form:input type="email" path="email" value="${driver.email}"
          class="form-control" name="" id="email"/>
      </div>
      <div class="form-group">
        <label for="licenceNo">LicenceNo</label>
        <form:input type="text" path="licenceNo" value="${driver.licenceNo}"
          class="form-control" name="" id="licenceNo"/>
      </div>
      <div class="form-group">
        <label for="cab">Cab</label>
        <form:input type="text" path="cab" value="${driver.cab.cabId}"
