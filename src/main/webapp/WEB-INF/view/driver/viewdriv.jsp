...
<body class="sub_page">
    ...
    <div class="hero_area">
      ...
      <div class="container" style= "background-color:white; margin: auto; padding-top: 20px;padding-bottom: 100px; width:600px;">
        ...
        <form:form action="/driver/getalldrivers" method="get" modelAttribute="drivers">
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text"  type="licenceNo" disabled  value="${drivers.licenceNo}"class="form-control" name="" id="licenceNo"/>
          </div>
          <div class="form-group">
            <label for="rating">Rating</label>
            <input type="text"  type="rating" disabled  value="${drivers.rating}"
              class="form-control" name="" id="rating"/>
          </div>
          <div class="form-group">
            <label for="available">Available</label>
            <input type="text"  type="available" disabled value="${drivers.available}"
