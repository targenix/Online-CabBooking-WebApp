...
pageEncoding="ISO-8859-1" import="java.util.*,org.cabbookingweb.entities.*,org.cabbookingweb.service.*"%>
...
<body class="sub_page">
    ...
    <div class="hero_area">
      ...
      <div class="container" style= "background-color:white; margin: auto; padding-top: 20px;padding-bottom: 100px; width:600px;">
        ...
        <form:form action="/driver/rate" modelAttribute="drivers" method="post">
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text"  type="email" disabled value="${drivers.email}"class="form-control" name="" id="email"/>
          </div>
          <div class="form-group">
            <label for="rating">Rating</label>
            <form:input type="text"  path="rating"  value="${drivers.rating}"
        ...
        <div class="form-group"style="text-align:center">
            <a href="/tripbooking/viewalltrips"><button type="submit" class="btn btn-primary">Back</button></a>
          </div>
    </div>
    </div>
