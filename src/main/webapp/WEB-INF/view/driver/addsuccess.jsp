...
<body class="sub_page">
  ...
  <div class="container" style= "background-color:white; margin: auto; padding-top: 70px; width:600px;">
    <form:form action="adddriver" modelAttribute="driver" method="get"> 
      <div class="alert alert-success"><h4 style="font-family:'Times New Roman', Times, serif ;text-align:center; color:olivedrab">Driver Registered Successfully</h4></div>
