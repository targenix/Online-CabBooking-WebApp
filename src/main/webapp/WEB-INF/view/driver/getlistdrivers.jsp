...
<body class="sub_page">
  ...
  <div class="container text-center" style= "background-color:white; margin: auto; padding-top: 10px;padding-bottom:200px">
    <h1 style="font-family:'Times New Roman', Times, serif ;text-align:center;color:chocolate">Drivers</h1>
        <table class="table table-dark" align="center">
            ...
            <tbody>
                <%
                List<Driver> lists = (List<Driver>) request.getAttribute("driver");

                    for(Driver drivers: lists)
                    {

                        out.println("<tr>");
                        out.println("<td scope=\"row\">"+drivers.getDriverId()+"</td>");
                        out.println("<td>"+drivers.getUserName()+" </td>");
                        out.println("<td>"+drivers.getEmail()+" </td>");
                        out.println("<td><a href=\"http://localhost:5000/driver/viewdrivers?driverId=" + drivers.getDriverId() + "\"><button>View</button></a></td>");
                        out.println("<td><a href=\"http://localhost:5000/driver/deldri?driverId=" + drivers.getDriverId() + "\"><button>Delete</button></a></td>");
                        out.println("</tr>");
