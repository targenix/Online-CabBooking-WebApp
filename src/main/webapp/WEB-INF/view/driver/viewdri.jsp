...
<body class="sub_page">
  ...
  <div class="container" style= "background-color:white; margin: auto; padding-top: 60px;padding-bottom: 100px; width:600px;">
    <div class="card card-body" style="background-color: burlywood;">
    <h3 style="font-family:'Times New Roman', Times, serif ;text-align:center; color:cornsilk">Your Profile</h3>
    <form:form action="/driver/editdriverdetails" modelAttribute="driver" method="get">
      <form:hidden path="driverId" value="${driver.driverId}"/> 
    <div class="form-group">
      <label for="userName">User Name</label>
      <input type="text" disabled path="userName" value="${driver.userName}"
        class="form-control" name="" id="userName"/>
    </div>
      <div class="form-group">
        <label for="mobileNumber">Mobile No</label>
        <input type="text" disabled path="mobileNumber" value="${driver.mobileNumber}"
          class="form-control" name="" id="mobileNumber"/>
      </div>
      <div class="form-group">
        <label for="email">Email id</label>
        <input type="text"  type="email" disabled path="email" value="${driver.email}"
