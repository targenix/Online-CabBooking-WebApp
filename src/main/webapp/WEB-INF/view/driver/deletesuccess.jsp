...
<body class="sub_page">
    ...
    <div class="hero_area">
      ...
      <div class="container text-center" style= "background-color:white; margin: auto; padding-top: 40px;padding-bottom:300px; width:600px;">
        <div class="alert alert-success"><h4 style="font-family:'Times New Roman', Times, serif ;text-align:center; color:olivedrab"> Record Deleted Successfully</h4></div>
        <div class="form-group">
          <a href="/driver/getalldrivers"><button type="submit" class="btn btn-lg btn-primary btn-block"> Back</button></a>
        </div>
        </div>
